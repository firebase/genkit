...
pineconeRetrieverRef: (params: {
    indexId: string;
    displayName?: string;
}) => import("@genkit-ai/ai/retriever").RetrieverReference<z.ZodObject<{
    k: z.ZodNumber;
