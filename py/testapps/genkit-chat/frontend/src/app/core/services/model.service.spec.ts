...
describe('ModelService pure logic', () => {
    const mockProviders: Provider[] = [
        ...
        },
        {
            ...
            available: true,
            models: [
                { id: 'anthropic/claude-sonnet-4', name: 'Claude Sonnet 4', capabilities: ['text', 'vision'] },
            ],
        },
        {
            id: 'openai',
...
describe('Model filtering and search', () => {
    const allModels = [
        { id: 'googleai/gemini-2.5-flash', name: 'Gemini 2.5 Flash', capabilities: ['text', 'vision'], provider: 'Google AI' },
        { id: 'googleai/gemini-2.5-pro', name: 'Gemini 2.5 Pro', capabilities: ['text', 'vision'], provider: 'Google AI' },
        { id: 'anthropic/claude-sonnet-4', name: 'Claude Sonnet 4', capabilities: ['text', 'vision'], provider: 'Anthropic' },
        { id: 'openai/gpt-4o', name: 'GPT-4o', capabilities: ['text', 'vision', 'audio'], provider: 'OpenAI' },
    ];
    ...
    it('should search models by name (case insensitive)', () => {
        ...
        const results = allModels.filter((m) => m.name.toLowerCase().includes(searchTerm.toLowerCase()));
