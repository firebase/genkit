...
const sampleProviders: Provider[] = [
    {
        ...
        models: [
            ...
            { id: 'googleai/gemini-2.0-pro', name: 'Gemini 2.0 Pro', capabilities: ['text', 'vision', 'streaming'] },
            { id: 'googleai/gemini-1.5-flash', name: 'Gemini 1.5 Flash', capabilities: ['text', 'vision', 'streaming'] },
        ],
    },
    {
        id: 'anthropic',
        ...
        available: true,
        models: [
            { id: 'anthropic/claude-3-sonnet', name: 'Claude 3 Sonnet', capabilities: ['text', 'streaming'] },
            { id: 'anthropic/claude-3-opus', name: 'Claude 3 Opus', capabilities: ['text', 'streaming'] },
            { id: 'anthropic/claude-3-haiku', name: 'Claude 3 Haiku', capabilities: ['text', 'streaming'] },
        ],
    },
    {
        id: 'openai',
        ...
        providers: [
            {
                ...
                available: true,
                models: [
                    { id: 'googleai/gemini-2.0-flash-experimental-0205', name: 'Gemini 2.0 Flash Experimental 0205' },
                    { id: 'googleai/gemini-2.0-pro-vision-latest', name: 'Gemini 2.0 Pro Vision Latest' },
                    { id: 'googleai/gemini-1.5-flash-8b-tuned-custom', name: 'Gemini 1.5 Flash 8B Tuned Custom' },
                ],
            },
        ],
        recentModels: [],
