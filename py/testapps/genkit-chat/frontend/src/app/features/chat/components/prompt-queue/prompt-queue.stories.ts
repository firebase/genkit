...
export const LongContent: Story = {
    args: {
        queue: [
            {
                id: '1',
                content: 'Can you explain the difference between REST and GraphQL APIs, including their pros and cons, and when to use each one?'
            },
            {
                id: '2',
                content: 'Write a comprehensive guide on setting up a production-ready Node.js application with TypeScript, including testing, linting, and CI/CD configuration'
            },
        ],
    },
};
...
export const WithCodeSnippets: Story = {
    args: {
        queue: [
            ...
            { id: '3', content: 'Optimize: for(let i=0; i<arr.length; i++) { for(let j=0; j<arr.length; j++) { ... } }' },
        ],
    },
};
