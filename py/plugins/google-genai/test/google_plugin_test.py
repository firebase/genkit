...
def vertexai_plugin_instance(client: MagicMock) -> VertexAI:
    ...
    # These are stored on the plugin instance, not the client
    plugin._project = 'test-project'  # type: ignore[attr-defined]
    plugin._location = 'us-central1'  # type: ignore[attr-defined]
    return plugin
