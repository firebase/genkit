...
class VertexAI(Plugin):
    ...
    def __init__(
        ...
        # Store project and location on the plugin instance for use by rerankers/evaluators
    ...
    def _resolve_reranker(self, name: str) -> Action:
        ...
        # Use project and location stored on the plugin instance during __init__
        # This avoids accessing private attributes of the client library
