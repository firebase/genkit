...
class Checks(Plugin):
    ...
    def __init__(
        self,
        project_id: str | None = None,
        evaluation: ChecksEvaluationConfig | None = None,
        credentials: Credentials | None = None,
    ) -> None:
        ...
        Args:
            ...
            evaluation: Optional evaluation configuration.
    ...
    async def init(self) -> list[Action]:
        ...
        Note: Evaluator registration cannot happen here because the Plugin
        base class does not provide direct access to the registry. Use
        ``define_checks_evaluators(ai, ...)`` after creating the Genkit
        instance, or pass ``evaluation`` config to register lazily.
