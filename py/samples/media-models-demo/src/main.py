...
async def tts_speech_generator_flow(
    text: Annotated[
        str, Field(default='Meow! The magnificent cat leaps gracefully across the rooftops at sunset!')
    ] = 'Meow! The magnificent cat leaps gracefully across the rooftops at sunset!',
) -> dict[str, Any]:
    ...
    Example:
        >>> result = await tts_speech_generator_flow(text='Good morning!')
...
async def gemini_image_generator_flow(
    prompt: Annotated[
        str, Field(default='A fluffy orange cat wearing a tiny crown, sitting on a velvet cushion')
    ] = 'A fluffy orange cat wearing a tiny crown, sitting on a velvet cushion',
) -> dict[str, Any]:
    ...
    Example:
        >>> result = await gemini_image_generator_flow(prompt='A cat astronaut')
    """
...
async def lyria_audio_generator_flow(
    prompt: Annotated[
        str, Field(default='Playful jazz music with soft piano and gentle purring cat sounds')
    ] = 'Playful jazz music with soft piano and gentle purring cat sounds',
) -> dict[str, Any]:
    ...
    Example:
        >>> result = await lyria_audio_generator_flow(prompt='Dance music')
    """
    negative_prompt = ''  # Not used by default
...
async def veo_video_generator_flow(
    prompt: Annotated[
        str, Field(default='A cat chasing a butterfly through a sunlit garden, cinematic slow motion')
    ] = 'A cat chasing a butterfly through a sunlit garden, cinematic slow motion',
) -> dict[str, Any]:
    ...
    Example:
        >>> result = await veo_video_generator_flow(prompt='A sunset over the ocean')
