...
from genkit.plugins.vertex_ai.model_garden import OpenAIFormatModelVersion, VertexAIModelGarden, vertexai_name
...
async def say_hi(name: str):
    ...
    return await ai.generate(
        model=vertexai_name(OpenAIFormatModelVersion.LLAMA_3_2),
        messages=[
            Message(
                role=Role.USER,
