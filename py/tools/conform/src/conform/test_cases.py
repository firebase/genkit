...
test cases, update BOTH files:
    ...
    Py:  py/tools/conform/src/conform/test_cases.py      (this file)
"""
...
# This is the same image used in the JS canonical source.
_IMAGE_BASE64 = (
    'iVBORw0KGgoAAAANSUhEUgAAByIAAAGdCAYAAABel7RVAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAAX'
    'NSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAADv9SURBVHgB7d1bchPn9jfgF58qdx97BH9xquIuMI'
    'KYEQRGgBkBZgSYEQAjwIwAMgKcEcS5SxXY1h7BZt+lbGy+tUwr2yEcbEl91PNUKZKND7LU3VLeX6'
    '+1SgEAAAAAAAAAAAAAAAAAAAAAAAAA'
)
