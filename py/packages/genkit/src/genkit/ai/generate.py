...
from genkit.ai.formats.types import FormatDef, Formatter
...
async def generate_action(
    ...
    def make_chunk(role: Role, chunk: GenerateResponseChunk) -> ModelResponseChunk:
        """Creates a ModelResponseChunk from role and data.
        ...
        Returns:
            A ModelResponseChunk containing the chunk and metadata.
        """
    ...
    if revised_model_msg:
        interrupted_resp = ModelResponse(
            response,
            request,
            message_parser=message_parser if formatter else None,
            schema_type=schema_type,
