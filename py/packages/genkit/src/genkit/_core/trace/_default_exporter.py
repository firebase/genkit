...
class TraceServerExporter(SpanExporter):
    ...
    def __init__(self, telemetry_server_url: str, telemetry_server_endpoint: str | None = None) -> None:
        """Initializes the TraceServerExporter.
...
def create_span_processor(exporter: SpanExporter) -> SpanProcessor:
    ...
    Uses RealtimeSpanProcessor in dev mode for live trace visualization.
    Uses BatchSpanProcessor in production for efficiency.
