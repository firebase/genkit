...
This module consolidates async utilities: Channel, loop helpers, and ensure_async.
"""
...
T = TypeVar('T')
T_co = TypeVarExt('T_co')  # Type of items in the channel
R = TypeVarExt('R', default=Any)  # Type of the close future result (defaults to Any)


# =============================================================================
# Channel: Async iterator for streaming with final value
# =============================================================================
...
class Channel(Generic[T_co, R]):
    ...
    def __aiter__(self) -> AsyncIterator[T_co]:
        ...
        Returns:
            AsyncIterator[T_co]: The channel object itself, which implements the
    ...
    async def __anext__(self) -> T_co:
        ...
        Returns:
            T_co: The next value from the channel.
        """
    ...
    async def _pop(self) -> T_co:
        ...
        Returns:
            T_co: The retrieved value from the channel.
        """
...
# =============================================================================
# Loop utilities: create_loop, run_async, iter_over_async, run_loop
# =============================================================================
...
# =============================================================================
# ensure_async: Wrapper to ensure functions are async
# =============================================================================
