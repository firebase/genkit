...
class ModelConfig(BaseModel):
    """Common configuration for model generation requests.

    This is the canonical wire type for model configuration. Plugins may extend
    this class for provider-specific options.
    """
