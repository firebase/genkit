...
class Genkit:
    ...
    def start_server(self) -> None:
        httpd = HTTPServer(('127.0.0.1', 3100), make_reflection_server(self.registry))
        httpd.serve_forever()
    ...
    def flow(self, name: Optional[str] = None) -> Callable[[Callable], Callable]:
    ...
    def define_model(
        ...
        action = Action(name=name, action_type=self.MODEL,
    ...
    def define_prompt(
        ...
        def prompt(input_prompt: Optional[Any] = None) -> GenerateResponse:
            req = fn(input_prompt)
        ...
        def wrapper(input_prompt: Optional[Any] = None) -> GenerateResponse:
