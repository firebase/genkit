...
class Score(GenkitModel):
    ...
    model_config: ClassVar[ConfigDict] = ConfigDict(alias_generator=to_camel, extra='forbid', populate_by_name=True)
    id: str | None = None
    score: str | float | bool | None = Field(default=None)
...
class ModelInfo(GenkitModel):
    ...
    stage: Literal['featured', 'stable', 'unstable', 'legacy', 'deprecated'] | None = None
...
class Supports(GenkitModel):
    ...
    constrained: Literal['none', 'all', 'no-tools'] | None = None
