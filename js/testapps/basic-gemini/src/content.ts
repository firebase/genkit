...
much hitherto unrevealed information on the invented languages and writing systems, Tolkien received many letters
from readers written in these systems, in addition to numerous enquiries on the finer points of their usage.
...
of names and strange words’ would appear in the third volume. As originally planned, this index would contain much
...
In 1965, stemming from what then appeared to be copyright problems in the United States, an American paperback
firm published an unauthorized and non-royalty-paying edition of The Lord of the Rings. For this new edition by Ace
...
but, rather, a bald index with only names and page references. Additionally, at this time the appendices were greatly
revised.
...
not always inserted correctly (thereby causing further confusion in the text), somehow never made it into the main
...
The revised text first appeared in Great Britain in a threevolume hardcover ‘Second Edition’ from Allen & Unwin on
...
to the second impression (1967) of the three-volume hardcover Allen & Unwin second edition. The revisions themselves mostly include corrections of nomenclature and
attempts at consistency of usage throughout the three volumes. Some small alterations were made by Tolkien in the
...
note on the text xv
rections, as errors have been discovered, to the British publishers of The Lord of the Rings (Allen & Unwin, later Unwin
Hyman, and now HarperCollins), who have tried to be conscientious in the impossible task of maintaining a textual
...
printed versions of the text. Beginning with the 1987 Houghton Mifflin edition, an earlier version of this ‘Note on the
...
the text of The Lord of the Rings was entered into wordprocessing files. This next stage of textual evolution came
...
text was transferred into page-making or typesetting programs – e.g., in one edition of The Fellowship of the Ring, the
closing two sentences of ‘The Council of Elrond’ simply and
inexplicably disappeared. Such glitches have been very much
the exception, not the rule, and the text has otherwise maintained a consistency and integrity throughout its computerized evolution.
The 1994 edition also contained a number of new corrections (again supervised by Christopher Tolkien), as well as a
reconfigured index of names and page references. The 1994
text was first used in American editions published by Houghton Mifflin in 1999. A small number of further corrections
...
The History of Middle-earth. Volumes six through nine contain the major part of his study pertaining to The Lord of the
...
of composition in The Return of the Shadow: ‘In the handwriting that he used for rapid drafts and sketches, not intended
to endure long before he turned to them again and gave them
a more workable form, letters are so loosely formed that a
word which cannot be deduced or guessed at from the context or from later versions can prove perfectly opaque after
long examination; and if, as he often did, he used a soft pencil
much has now become blurred and faint.’ The true difficulty
of reading such double-drafts can be observed in the frontispiece to The War of the Ring, which reproduces in colour
...
Christopher Tolkien reproduces a page from the first manuscript of the chapter ‘The Taming of Sme´agol’, and the
...
thinking on paper. This gives an added dimension of understanding to Tolkien’s comment to Stanley Unwin in a 1963
...
as if from nowhere, or of some other sudden change or development, at the very moment of their emergence into the
story.
...
beyond simple narrative text. There are maps and illustrations. There are languages and writing systems, and the histories of the peoples who spoke and wrote in these systems.
...
Douglas A. Anderson
May 2004
NOTE ON THE 50 TH ANNIVERSARY
EDITION
In this edition of The Lord of the Rings, prepared for the
fiftieth anniversary of its publication, between three and four
hundred emendations have been made following an exhaustive review of past editions and printings. The present text
...
while his publisher, Rayner Unwin, learned of it only thirtyeight years after the fact. Tolkien found a few of the unauthorized changes introduced in the second printing when
...
note on the 50th anniversary edition xxi
...
Christina Scull has published ‘A Preliminary Study of Variations in Editions of The Lord of the Rings’ in Beyond Bree
(April and August 1985); Wayne G. Hammond has compiled
extensive lists of textual changes in J.R.R. Tolkien: A Descriptive Bibliography (1993); and David Bratman has published
...
xxii note on the 50th anniversary edition
as compared with real annals or genealogies! Anyway the
slips were few, have now mostly been removed, and the discovery of what remain seems an amusing pastime! But errors
in the text are another matter’ (italics ours). In fact Tolkien
had not ‘ceased to bother’, and ‘slips’ were dealt with as
opportunities arose. These, and the indulgence of his publisher, allowed Tolkien a luxury few authors enjoy: multiple
...
that inconsistencies in its text were almost inevitable. Christopher Tolkien even observed to us that some apparent
inconsistencies of form in his father’s work may even have
been deliberate: for instance, although Tolkien carefully distinguished house ‘dwelling’ from House ‘noble family or dynasty’, in two instances he used house in the latter sense but
...
note on the 50th anniversary edition xxiii
...
more felicitous – subtle points, when one is comparing commas and semi-colons, but no less a part of the author’s
intended expression. Distinctive words such as chill rather
than cold, and glistered rather than glistened, changed by typesetters long ago without authorization, likewise have been
restored. A controlled amount of regularization also seemed
called for, such as naught rather than nought, a change instituted by Tolkien but not carried through in all instances;
Dark Power rather than dark power when the reference is
obviously to Sauron (orMorgoth);Barrow-downs by Tolkien’s
...
personification or metaphor, according to Tolkien’s predominant practice and the internal logic of the text; and Elvish
...
to adjacent adjectives, or whether Tolkien intended personification, poetry, or emphasis. His intent cannot be divined
...
xxiv note on the 50th anniversary edition
the author’s intentions, the text has been allowed to stand.
Most of the demonstrable errors noted by Christopher
Tolkien in The History of Middle-earth also have been corrected, such as the distance from the Brandywine Bridge to
...
such an extensive review of its text, deserve to be fully documented. Although most readers will be content with the text
...
hobbits and their adventures. But the story was drawn irresistibly towards the older world, and became an account, as
...
year later when I went on and so came to Lothlo´rien and the
...
the beacons flared in Ano´rien and The´oden came to Harrowdale I stopped. Foresight had failed and there was no time
for thought.
It was during 1944 that, leaving the loose ends and perplexities of a war which it was my task to conduct, or at least to
...
have received or have read concerning the motives and meaning of the tale. The prime motive was the desire of a tale-teller
...
been annihilated but enslaved, and Barad-duˆr would not have
been destroyed but occupied. Saruman, failing to get possession of the Ring, would in the confusion and treacheries
...
readers. I think that many confuse ‘applicability’ with ‘allegory’; but the one resides in the freedom of the reader, and
...
attractive, when the lives of an author and critic have overlapped, to suppose that the movements of thought or the
...
the plot, foreseen from the outset, though in the event modified by the character of Saruman as developed in the story
without, need I say, any allegorical significance or contemporary political reference whatsoever. It has indeed some
basis in experience, though slender (for the economic situation was entirely different), and much further back. The
...
or indeed by the production of an accessory volume containing much of the material that I did not include in the original
...
Many, however, may wish to know more about this remarkable people from the outset, while some may not possess
...
and quiet and good tilled earth: a well-ordered and wellfarmed countryside was their favourite haunt. They do not
...
Their faces were as a rule good-natured rather than beautiful, broad, bright-eyed, red-cheeked, with mouths apt to
...
traditions are concerned almost entirely with their own history, in which Men appear seldom and Hobbits are not mentioned at all. Yet it is clear that Hobbits had, in fact, lived
...
Harfoots and followed the course of the Loudwater southwards; and there many of them long dwelt between Tharbad
...
Elves. Indeed, a remnant still dwelt there of the Du´nedain, the
kings of Men that came over the Sea out of Westernesse; but
they were dwindling fast and the lands of their North Kingdom were falling far and wide into waste. There was room
and to spare for incomers, and ere long the Hobbits began
to settle in ordered communities. Most of their earlier settlements had long disappeared and been forgotten in Bilbo’s
...
art from the Elves. And in those days also they forgot whatever languages they had used before, and spoke ever after the
...
history with a reckoning of years. For it was in the one thousand six hundred and first year of the Third Age that the
...
the Du´nedain may be found by adding 1600 to the dates of Shirereckoning.
prologue 7
...
the Brandywine. The Hobbits of that quarter, the Eastfarthing, were rather large and heavy-legged, and they wore
...
Marish, and of Buckland, east of the River, which they afterwards occupied, came for the most part later into the Shire
...
beside, was derived from the Du´nedain. But the Hobbits may
...
other ways, such as their friendship with the Elves.) Sometimes, as in the case of the Tooks of Great Smials, or the
...
brought over Sea by the Men of Westernesse. It grows abundantly in Gondor, and there is richer and larger than in the
...
Elendil and our own days. But even the Du´nedain of Gondor
...
Families for the most part managed their own affairs. Growing food and eating it occupied most of their time. In
other matters they were, as a rule, generous and not greedy,
but contented and moderate, so that estates, farms, workshops, and small trades tended to remain unchanged for
generations.
There remained, of course, the ancient tradition concerning the high king at Fornost, or Norbury as they called it,
...
for the office of Thain had passed to them (from the Oldbucks) some centuries before, and the chief Took had borne
that title ever since. The Thain was the master of the Shiremoot, and captain of the Shire-muster and the Hobbitry-inarms; but as muster and moot were only held in times of
...
habits and even adventurous temperament. The latter qualities, however, were now rather tolerated (in the rich) than
...
had, of course, no uniforms (such things being quite unknown), only a feather in their caps; and they were in practice
...
how little he revealed to no one, not even to Frodo his favourite ‘nephew’. And he still kept secret the ring that he had
found.
4
...
him: none other, indeed, than Thorin Oakenshield, descendant of kings, and his twelve companions in exile. With them
...
happened that Bilbo was lost for a while in the black orcmines deep under the mountains, and there, as he groped in
...
the way out, lest the ‘thief’ should escape. Warily Bilbo followed him, as he went along, cursing, and talking to himself
...
occurred in the Shire until Mr. Baggins began the preparations for the celebration of his hundred-and-eleventh
...
Reunited Kingdom awakened among them a more widespread interest in their own history; and many of their traditions, up to that time still mainly oral, were collected and
...
books and records.
The largest of these collections were probably at Undertowers, at Great Smials, and at Brandy Hall. This account of
...
at the request of the great-grandson of Peregrin, and completed in S.R. 1592 (F.A. 172). Its southern scribe appended
...
Minas Tirith it received much annotation, and many corrections, especially of names, words, and quotations in the Elvish
...
some time after the passing of the King. But the chief importance of Findegil’s copy is that it alone contains the whole of
...
names.
At Great Smials the books were of less interest to Shirefolk, though more important for larger history. None of them
...
and his heirs. Only here in the Shire were to be found extensive materials for the history of Nu´menor and the arising of
...
conjectural, especially for the Second Age, they deserve attention. It is probable that Meriadoc obtained assistance and
...
generous with his money, most people were willing to forgive him his oddities and his good fortune. He remained
...
eleventy-one, 111, a rather curious number, and a very respectable age for a hobbit (the Old Took himself had only
...
stiff in the joints, the job was mainly carried on by his youngest son, Sam Gamgee. Both father and son were on very
...
recognized as the leading authority by all in the neighbourhood (including himself ).
...
‘You’re right, Dad!’ said the Gaffer. ‘Not that the Brandybucks of Buckland live in the Old Forest; but they’re a queer
...
‘But I reckon it was a nasty knock for those SackvilleBagginses. They thought they were going to get Bag End,
...
had me up at Bag End helping him to keep folks from trampling and trapessing all over the garden while the sale was
...
waggon laden with odd-looking packages rolled into Hobbiton one evening and toiled up the Hill to Bag End. The
...
cart came in through Bywater from the direction of Brandywine Bridge in broad daylight. An old man was driving it all
alone. He wore a tall pointed blue hat, a long grey cloak, and
a silver scarf. He had a long white beard and bushy eyebrows
that stuck out beyond the brim of his hat. Small hobbitchildren ran after the cart all through Hobbiton and right up
...
Hobbiton post-office was blocked, and the Bywater postoffice was snowed under, and voluntary assistant postmen
...
A notice appeared on the gate at Bag End: no admittance except on party business. Even those who had,
...
had never seen before, all beautiful and some obviously magical. Many of them had indeed been ordered a year before,
...
crackers, backarappers, sparklers, torches, dwarf-candles, elffountains, goblin-barkers and thunder-claps. They were all
...
Tooks and Brandybucks; there were various Grubbs (relations of Bilbo Baggins’ grandmother), and various Chubbs
...
All the one hundred and forty-four guests expected a pleasant feast; though they rather dreaded the after-dinner speech
...
Burrowses, and Hornblowers, and Bolgers, Bracegirdles, Goodbodies, Brockhouses and Proudfoots. ‘Proudfeet!’ shouted an
...
and eleventh birthday: I am eleventy-one today! ‘Hurray! Hurray! Many Happy Returns!’ they shouted, and they hammered joyously on the tables. Bilbo was doing splendidly.
This was the sort of stuff they liked: short and obvious.
I hope you are all enjoying yourselves as much as I am. Deafening cheers. Cries of Yes (and No). Noises of trumpets and
horns, pipes and flutes, and other musical instruments. There
were, as has been said, many young hobbits present. Hundreds of musical crackers had been pulled. Most of them
...
to have finished (since he had plainly said all that was necessary), now got up an impromptu orchestra, and began a
...
They all feared that a song or some poetry was now imminent; and they were getting bored. Why couldn’t he stop
...
eyes Bilbo was nowhere to be seen. One hundred and fortyfour flabbergasted hobbits sat back speechless. Old Odo
...
that was standing there, already nearly full. Into the envelope he slipped his golden ring, and its fine chain, and then
...
‘Well, I’ve made up my mind, anyway. I want to see mountains again, Gandalf – mountains; and then find somewhere
...
came over his voice. It was sharp with suspicion and annoyance. ‘You are always badgering me about my ring; but you
...
darkness. ‘Good-bye, my dear Bilbo – until our next meeting!’ he said softly and went back indoors.
...
doubt everything will be cleared up in the morning. About midnight carriages came for the important folk. One by one
they rolled away, filled with full but very unsatisfied hobbits.
Gardeners came by arrangement, and removed in wheelbarrows those that had inadvertently remained behind.
...
cracker-paper, the forgotten bags and gloves and handkerchiefs, and the uneaten food (a very small item). Then a
number of other people came (without orders): Bagginses,
and Boffins, and Bolgers, and Tooks, and other guests that
lived or were staying near. By mid-day, when even the bestfed were out and about again, there was a large crowd at Bag
...
Dora was Drogo’s sister and the eldest surviving female relative of Bilbo and Frodo; she was ninety-nine, and had written
...
mirror. She was a young Baggins, and too obviously considered her face shapely.
For the collection of HUGO BRACEGIRDLE, from a contributor; on an (empty) book-case. Hugo was a great borrower
...
bottles of Old Winyards: a strong red wine from the Southfarthing, and now quite mature, as it had been laid down by
...
nuisance and a disturber of the peace. Some people are actually accusing me of spiriting Bilbo away, or worse. If you
