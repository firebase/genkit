...
If this new plugin uses an LLM as a judge and the plugin supports swapping out
...
These examples can be human generated or you can ask an LLM to help create a
